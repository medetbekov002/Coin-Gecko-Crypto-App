...
import com.example.coingeckocryptoapp.presentation.CoinListViewModel
import com.example.coingeckocryptoapp.presentation.coinlist.CoinAdapter
...
class MainActivity : AppCompatActivity(), SearchView.OnQueryTextListener {
                ...
                coinListViewModel._coinListValue.collect { value ->
                    when {
                        ...
                        value.coinList.isNotEmpty() -> {
                            progressBar.visibility = View.GONE
                            valueRepeat = 0
                            tempCoinList.addAll(value.coinList)
    ...
    private fun recyclerView() {
        ...
        coinRecyclerView.addItemDecoration(
            DividerItemDecoration(
                coinRecyclerView.context,
